...
Users and Groups
Users and groups help manage access control.

Sudo
sudo allows a permitted user to run commands with elevated privileges.

SUID and SGID
Special permission bits that can affect privilege behavior.
...
Why Security Learners Should Practice Linux
Linux helps you understand:

how systems work
how permissions work
how services run
how tools behave
how to move through a system efficiently
...
Final Note
Linux is not just another topic in cybersecurity.
